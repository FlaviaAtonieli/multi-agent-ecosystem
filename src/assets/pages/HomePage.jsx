    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <Header
        rightAction={
          <Link
            to="/auth"
            className="inline-flex items-center rounded-full border border-white/12 bg-white/6 px-5 py-2.5 text-[11px] font-light uppercase tracking-[0.28em] text-white/78 backdrop-blur-md transition duration-300 hover:border-cyan-300/30 hover:bg-white/10 hover:text-white hover:shadow-[0_0_30px_rgba(110,231,255,0.18)]"
          >
            Login / Cadastro
          </Link>
        }
