# Agent Skill — Código Legado

## Identificação
- Nome: Agent Skill de Código Legado
- Versão: 1.0
...
## Objetivo
Analisar sistemas legados, identificar dependências entre módulos, regras de
negócio implícitas e riscos técnicos associados a uma mudança solicitada,
utilizando evidência recuperada da base de conhecimento indexada (código-fonte,
documentação e schema de banco de dados).

## Capacidades
- Recuperar trechos relevantes de código-fonte e documentação legada
- Identificar dependências entre módulos e regras de negócio implícitas
- Mapear riscos técnicos associados à mudança solicitada
...
- Lista de impactos/riscos mapeados
...
## Exemplos de Uso
- "Analisar o impacto de tornar o limite de crédito específico por segmento de cliente."
- "Mapear quais módulos dependem da regra atual de limite de crédito global."
